...
export default function Home() {
  ...
  useEffect(() => {
    ...
    setStart(moment().subtract(10, 'day').format('DD-MM-YYYY'));
  }, []);
    ...
    <div>
      ...
      <div className="relative app-container flex flex-col p-4 gap-4 w-[95%] mx-auto h-[auto] max-h-[80vh] bg-white mt-5 rounded-md shadow-lg transform transition-transform ">
        ...
        <div className="flex flex-col md:flex-row w-full gap-4">
          ...
          <div className="flex-1">
            <TrafficSection trafficNumber={daily} percentChange="-2.3" name='Weekly' />
          </div>
          <div className="flex-1">
            <TrafficSection trafficNumber={daily} percentChange="0.8" name='Monthly' />
          </div>
        </div>
      </div>
      ...
      <div className="relative app-container flex flex-col p-4 gap-4 w-[95%] mx-auto h-[auto] max-h-[80vh] bg-white mt-5 rounded-md shadow-lg transform transition-transform ">
        ...
        <div className="flex flex-col md:flex-row w-full gap-4">
          <div className="flex-1">
            <TrafficSection trafficNumber={daily} percentChange="-0.6" name='Yesterday' />
          </div>
          <div className="flex-1">
            <TrafficSection trafficNumber={daily} percentChange="2.3" name='Weekly' />
          </div>
          <div className="flex-1">
            <TrafficSection trafficNumber={daily} percentChange="-10.0" name='Monthly' />
          </div>
        </div>
      </div>
...
<WeeklyProgressBarGraph weekData={weekData} />
</div>
